            ...
            <div key={member.id} className="group">
              <div className="relative overflow-hidden rounded-3xl mb-6 aspect-[4/4]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-4 group-hover:translate-y-0 flex justify-end gap-3">
                   <a href="#" aria-label={`${member.name}'s Facebook`} className="p-2 bg-amber-500 text-stone-900 rounded-full hover:bg-white transition-colors cursor-pointer"><Facebook size={16} aria-hidden="true" /></a>
                   <a href="#" aria-label={`${member.name}'s Twitter`} className="p-2 bg-amber-500 text-stone-900 rounded-full hover:bg-white transition-colors cursor-pointer"><Twitter size={16} aria-hidden="true" /></a>
                   <a href="#" aria-label={`${member.name}'s LinkedIn`} className="p-2 bg-amber-500 text-stone-900 rounded-full hover:bg-white transition-colors cursor-pointer"><Linkedin size={16} aria-hidden="true" /></a>
                </div>
              </div>
              <div>
