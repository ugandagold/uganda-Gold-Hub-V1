...
const SectionProjects: React.FC = () => {
  ...
  return (
    <section id="projects" ref={sectionRef} className={`py-24 bg-[#F5F5F4] transition-all duration-1000 ease-out transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
