...
const SectionServices: React.FC = () => {
  ...
  return (
    <section id="services" ref={sectionRef} className={`py-24 bg-stone-50 transition-all duration-1000 ease-out transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
